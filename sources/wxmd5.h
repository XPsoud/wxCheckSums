...
private:
	void Initialize();
	void Transform(const wxUint8 block[wxMD5_BlocSize]);
	...
	bool m_bFinalized;
	wxUint8 m_uiBuffer[wxMD5_BlocSize]; // bytes that didn't fit in last 64 byte chunk
